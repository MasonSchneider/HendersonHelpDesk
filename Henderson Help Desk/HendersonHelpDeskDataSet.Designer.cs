...
namespace Henderson_Help_Desk {
    ...
    public partial class HendersonHelpDeskDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/HendersonHelpDeskDataSet.xsd";
        ...
        public partial class TicketsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TicketsRow AddTicketsRow(string name, string computer, string type, string issue, bool _fixed, System.DateTime date, string address, string phone, string os, string zip, string state, string city) {
...
namespace Henderson_Help_Desk.HendersonHelpDeskDataSetTableAdapters {
    ...
    public partial class TicketsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Tickets] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([computer] = @Original_computer) AND ([type] = @Original_type) AND ([fixed] = @Original_fixed) AND ([date] = @Original_date) AND ([address] = @Original_address) AND ([phone] = @Original_phone) AND ([os] = @Original_os))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Tickets] ([name], [computer], [type], [issue], [fixed], [date], [address], [phone], [os]) VALUES (@name, @computer, @type, @issue, @fixed, @date, @address, @phone, @os);
SELECT id, name, computer, type, issue, fixed, date, address, phone, os FROM Tickets WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Tickets] SET [name] = @name, [computer] = @computer, [type] = @type, [issue] = @issue, [fixed] = @fixed, [date] = @date, [address] = @address, [phone] = @phone, [os] = @os WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([computer] = @Original_computer) AND ([type] = @Original_type) AND ([fixed] = @Original_fixed) AND ([date] = @Original_date) AND ([address] = @Original_address) AND ([phone] = @Original_phone) AND ([os] = @Original_os));
SELECT id, name, computer, type, issue, fixed, date, address, phone, os FROM Tickets WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, computer, type, issue, fixed, date, address, phone, os FROM dbo." +
                "Tickets";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_computer, string Original_type, bool Original_fixed, System.DateTime Original_date, string Original_address, string Original_phone, string Original_os) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((bool)(Original_fixed));
        ...
        public virtual int Insert(string name, string computer, string type, string issue, bool _fixed, System.DateTime date, string address, string phone, string os) {
            if ((name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((bool)(_fixed));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((bool)(_fixed));
            ...
            if ((Original_computer == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_computer));
            }
            if ((Original_type == null)) {
                throw new global::System.ArgumentNullException("Original_type");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((bool)(Original_fixed));
        ...
        public virtual int Update(
                    ...
                    string Original_phone, 
                    string Original_os) {
            return this.Update(name, computer, type, issue, _fixed, date, address, phone, os, Original_id, Original_name, Original_computer, Original_type, Original_fixed, Original_date, Original_address, Original_phone, Original_os, Original_id);
        }
    }
